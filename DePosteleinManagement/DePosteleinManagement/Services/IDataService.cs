...
namespace DePosteleinManagement.Services
{
    public interface IDataService
    {
        ...
        Dish CreateNewDish(string dishName, Menu menu, UserRole userRole, User loggedInUser);
        Menu CreateNewMenu(string menuName, double price, bool variableAmount);
        Event CreateNewEvent(string menuName, int guests, int bread, string customer, string location, long date, User loggedInUser);
        ...
        void EditEvent(string menuName, int guests, int bread, string customer, string location, long epocheDate, int id);
