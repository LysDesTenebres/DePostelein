...
public class EventDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        err.setText("Locatie: "  + event.getLocation());

        TextView err2 = (TextView)findViewById(R.id.textView2);
        err2.setText( "Menu: " + event.getMenu() + " | Broodjes: " + event.getBread());
    ...
    private class GrabURL extends AsyncTask<String, Void, String[]> {
        ...
        private ProgressDialog dialog =
                new ProgressDialog(EventDetailActivity.this);
        ...
        protected String[] doInBackground(String... urls) {
            ...
            String urlMenu = "http://10.0.2.2:8910/api/eventMenu/admin";
            String[] results = null;
            String result;
            try {
        ...
        protected void onCancelled() {
            dialog.dismiss();
            Toast toast = Toast.makeText(EventDetailActivity.this,
        ...
        protected void onPostExecute(String[] content) {
            ...
            Toast toast;
            if (error) {
                toast = Toast.makeText(EventDetailActivity.this,
                        "", Toast.LENGTH_LONG);
                toast.setGravity(Gravity.TOP, 25, 400);
                toast.show();
            } else {
    ...
    private void displayEventList(String[] response) {
        ...
        ingredients = gson.fromJson(response[0], listTypeIngredients);

        Type listTypeDeliverer = new TypeToken<ArrayList<Deliverer>>() {
        }.getType();
        deliverer = gson.fromJson(response[1], listTypeDeliverer);


        ExpandableListView listView = findViewById(R.id.expandableListView);
        //create an ArrayAdaptar from the String Array
        dataAdapter = new MyCustomAdapter(this, deliverer, ingredients);
    ...
    private class MyCustomAdapter extends BaseExpandableListAdapter {
        ...
        private ArrayList<Deliverer> delivererList;
        private ArrayList<Ingredients> ingredientsList;
        private Context context;

        public MyCustomAdapter(Context context, ArrayList<Deliverer> delivererList, ArrayList<Ingredients> ingredientsList) {
            this.delivererList = new ArrayList<>();
            this.delivererList.addAll(delivererList);
        ...
        public Object getChild(int groupPosition, int childPosition) {
            ...
            for (Ingredients ingredient : ingredientsList){
                if (delivererList.get(groupPosition).getId() == ingredient.getDelivererId() ){
        ...
        public Object getGroup(int groupPosition) {
            return delivererList.get(groupPosition);
        }

        @Override
        public int getGroupCount() {
            return delivererList.size();
        }
        ...
        public View getGroupView(int groupPosition, boolean isLastChild, View view,
            ...
            Deliverer deliverer = (Deliverer) getGroup(groupPosition);
            if (view == null) {
            ...
            heading.setText(deliverer.getName());
